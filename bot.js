...
/* 			  for (var i = 0; i < results.length; i++) {
	...
	switch(cmd) {
		...
		case "add":
			...
			msg.channel.send("<:main_computer:420575980198035456> :headphones: :mag_right: `[Main Computer] Radio @ WA.Net# "+msg.content.split(' ')[2]+" sent in game request for`"+searchRaw.substring(1)+" `...`");	
			console.log(searchRaw);
			var YouTube = require('youtube-node');
